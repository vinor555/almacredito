...
export default function DatosComplementarios() {
  ...
  const [otraFuente, setOtraFuente] = useState("");
  ...
  const handleChangeMonedaAdicional = (event) => {
    setMonedaAdicional(event.target.value);
  };
  ...
  const handleChangeOtraFuente = (event) => {
    setOtraFuente(event.target.value);
  };
  ...
  return (
    <form className={classes.root} noValidate autoComplete="off">
      ...
      <div className={classes.section1}>
        <TextField
          id="outlined-required"
          label="Monto Aprox Mensual Otra Fuente Ing"
          defaultValue=""
          variant="outlined"
          size="small"
          className={classes.formControlLG}
        ...
        >
          ...
          <Select
            labelId="demo-simple-select-outlined-label"
            id="demo-simple-select-outlined"
            value={monedaAdicional}
            onChange={handleChangeMonedaAdicional}
            label="Moneda"
          >
            <MenuItem key={1} value={1}>
              GTQ
      ...
      <div className={classes.section1}>
        ...
        >
          ...
          <Select
            ...
            id="demo-simple-select-outlined"
            value={otraFuente}
            onChange={handleChangeOtraFuente}
            label="Moneda"
          >
            <MenuItem key={1} value={1}>
      ...
      <div className={classes.section1}>
        <TextField
          id="outlined-required"
          label="Especifique Otra Fuente Ing."
          defaultValue=""
          variant="outlined"
          size="small"
          className={classes.formControlLG}
